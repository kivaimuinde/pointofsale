<%-- 
    Document   : inactive
    Created on : Jan 27, 2023, 4:07:49 PM
    Author     : softnut
--%>
                ...
                <div class="container-fluid h-100 ">
                    <div class="d-flex row justify-content-center align-items-center h-100">
                        <div class="alert alert-info">
                            <p class="h2 align-items-center">Inactive Accounts</p>
                            ...
                            ResultSet rs=UserController.inactiveAccounts(m);
                            int count=0;
                            if(!rs.next()){
                            %>
                            <tr>
                                <td colspan="4">
                                    <div>
                                        <p class="text text-default">There are no inactive accounts. Please check again later<br>
