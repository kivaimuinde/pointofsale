<%-- 
    Document   : suspend
    Created on : Jan 27, 2023, 4:18:55 PM
    Author     : softnut
--%>
...
<html>
    <head>
        ...
        <title>Suspend user Account (<%=request.getParameter("username")%>)</title>
   ...
   response.sendRedirect(request.getContextPath()+"/account_status.jsp");
        ...
        <jsp:include page="../side_nav.jsp"></jsp:include>
            ...
            <main style="margin-top: 58px;">
                <div class="container-fluid h-100 alert alert-info ">
                    <div class="row d-flex justify-content-center align-items-center h-100">
                        <div class="col col-sm-12 col-md-12 col-lg-8 col-xl-8">
                            <p class="h2 align-items-center">Suspend <%=request.getParameter("username")%>'s Account</p>
                    </div>
                    <%
                    ...
                    int x=UserController.suspendAccount(model);
                
                    if(x>0){
                    //update successful: show message
                    %>
                    <div class="col col-sm-12 col-md-12 col-lg-8 col-xl-8">
                        <p class="text text-default">Account successfully suspended. Click <a href="<%=request.getContextPath()%>/accounts">here</a> to go back.</p>
                    </div>
                    <%
                    }else{
